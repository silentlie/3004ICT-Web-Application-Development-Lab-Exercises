...
$posts = [
    [
        "username" => "alice123",
        "message" => "Just finished learning the basics of PHP!",
        "date" => "2026-07-18",
        "comments" => [
            "Great work!",
            "PHP is a useful language.",
            "Keep going!"
        ]
    ],
    [
        "username" => "bob_dev",
        "message" => "Working on my first Laravel application.",
        "date" => "2026-07-17",
        "comments" => [
            "What are you building?",
            "Laravel is great for web applications."
        ]
    ],
    [
        "username" => "charlie_codes",
        "message" => "Does anyone have recommendations for learning databases?",
        "date" => "2026-07-16",
        "comments" => [
            "Start with MySQL.",
            "Learn basic SQL queries first.",
            "PostgreSQL is also a good option."
        ]
    ]
];
?>
